...
{
    public class PrioritizeMechFilterTest : TestBase
    {
        [Fact]
        public void Given_scan_without_mech_should_return_false()
        {
            // Arrange
            var sut = _mockProvider.Create<PrioritizeMechFilter>();
        ...
        [Fact]
        public void Given_scan_with_mech_should_return_true()
        {
            // Arrange
            var sut = _mockProvider.Create<PrioritizeMechFilter>();
            var filter = sut.GetPredicate();
